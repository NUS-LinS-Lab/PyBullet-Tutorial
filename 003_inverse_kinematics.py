...
for i in range(100000):
    ...
    # Inverse Kinematics
    joint_positions = p.calculateInverseKinematics(pandaID, eef_id, target_pos, target_orn)

    # Set joint states directly (instant IK solution)
    for idx, joint_idx in enumerate(controlled_joints):
        p.resetJointState(pandaID, joint_idx, joint_positions[idx])
